# create_features.py - SIMPLE VERSION (No emojis)
import os
    ...
    <div class="split-container">
        ...
        <div class="panel right-panel">
            ...
            <div class="complaint" id="complaint1">
                ...
                <p>"Invested Rs.50,000, got only Rs.2,500 after 1 year. That's 5% not 15%!"</p>
                <small>Twitter user @InvestorRohit, 2 days ago</small>
            </div>
            
            <div class="complaint" id="complaint2">
                <h4>Hidden Charges</h4>
                <p>"They deducted Rs.500 as 'processing fee' that was never mentioned!"</p>
...
<body>
    <div class="header">
        <h1>MIS-SELLING HEATMAP - INDIA</h1>
...
print("\\nInfluencer analysis complete!")'''
    ...
    print("=" * 60)
    print("\\nTo launch everything, create a launch.bat file manually.")
